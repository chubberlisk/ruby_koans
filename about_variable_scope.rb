...
class AboutVariableScope < Neo::Koan
  ...
  # With class variables, there are only a single copy of them which is shared amongst
  # all the instances of the class.
  #
  # With instance variables, each instance of a class has their own copy. Therefore,
  # values of the instance variable may differ to one another.
