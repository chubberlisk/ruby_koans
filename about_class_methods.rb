...
class AboutClassMethods < Neo::Koan
  ...
  # If there are a large number of class methods, I would prefer the
  # second way because they are all grouped together. 
  #
  # If there are only a few class methods (one or two), I may opt to
  # use the first way.
  # ------------------------------------------------------------------
