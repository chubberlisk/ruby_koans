...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Parameter is the initial value for the accumulative variable.
    # E.g. for `result`, the initial value is 0 for `sum`.
    # The accumulative variable is iteratively updated using itself 
    # and an item in the array.
    # The final value of `sum` is then returned.
  end
  ...
  # So that the file is only opened as long as it needs to be or
  # to ensure that the file is not accidentally modified.
end
