...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # If the rest of the regexp fails to match, then * will fail also.
    # https://github.com/nathantypanski/ruby-koans/blob/master/about_regular_expressions.rb
    assert_equal nil, ""[/az*/]
  end
  ...
  # They will take the first instance it finds. It stops as searching
  # as soon as it finds a valid match.
  ...
  #
  # ([...]) is faster than (|) as (|) has to backtrack between each alternation,
  # whereas character class works sequentially.
  # https://stackoverflow.com/questions/22132450/why-is-a-character-class-faster-than-alternation 
  #
  # Character classes are optimised for matching one out of some set of characters,
  # whereas alternation allows for more general choices of varying lengths.
  ...
  def test_sub_is_like_find_and_replace
    # "one two-three".scan(/(t\w*)/) => [["two"], ["three"]]
    # $1[0, 1] => "t"
